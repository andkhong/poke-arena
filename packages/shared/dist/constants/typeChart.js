...
exports.typeEffectiveness = exports.ALL_TYPES = void 0;
...
function getTypeEffectiveness(attacking, defendingTypes) {
    const chart = exports.typeEffectiveness[attacking];
    if (!chart)
        return 1;
